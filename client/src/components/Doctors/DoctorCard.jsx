  ...
  return (
    <div className='p-3 lg:p-5'>
      ...
      <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 ;g:px-6 text-[12px] leading-4 
        lg:text-[16px] lg:leading-7 text-semibold rounded'>
          {specialization}
        </span>

        <div className='flex items-center gap-[6px]'>
          <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px]
          lg:leading-7 font-semibold text-headingColor'><img src={starIcon} alt="" />{avgRating}
          </span>
          <span className='text-[14px] leading-6 lg:text-[16px]
          lg:leading-7 font-[400] text-headingColor'>({totalRating})</span>
        </div>
      </div>
      ...
      <div className='mt-[18px lg:mt-5 flex items-center justify-between'>
        <div>
          ...
          <p className='text-[14px] leading-6 fint-[400] text-textColor'>
            At {hospital}
          </p>
        </div>
