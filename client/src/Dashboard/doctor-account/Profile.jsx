...
const Profile = ({ doctorData }) => {
    ...
    // Reusable function for adding items to the form
  ...
  return (
    <div>
        ...
        <form>
                        ...
                        <div>
                            <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                                ...
                                <div className='flex items-center'>
                                    <button onClick={e=>deleteTimeSlots(e,index)} className='bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 mb-[30px]
                                    cursor-pointer mt-6'> 
                                        <AiOutlineDelete/>
                                    </button>
                                </div>
            ...
            <div className="mt-7">
                <button type='submit' onClick={updateProfileHandler} className='bg-primaryColor text-white text-[18px] w-full py-3 px-4 leading-[30px] rounded-lg'>
                    Update Profile
                </button>
            </div>
        </form>
