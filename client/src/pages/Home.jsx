            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className='text__para'>
                  We provide the best healthcare solutions to our patients. 
                  Our goal is to provide the best healthcare solutions to our patients.
                </p>
              ...
              lg:gap-[30px]'>
                ...
                <div>
                  ...
                  <p className='text__para'>Patient Satisfactoin</p>
                </div>
              </div>
            </div>
            {/* Hero content */}
        ...
        <div className='container'>
          ...
          lg:mt-[55px]'>
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                <h2 className='text-[24px] leading-9 font-[700] text-headingColor text-center'>
                  Find a Doctor
                </h2>
                ...
                [#101A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor
                hover:border-none'>
